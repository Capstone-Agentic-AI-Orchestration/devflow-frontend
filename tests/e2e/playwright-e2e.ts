...
// Markers present in the migrated marketing home view (MarketingHomeView)
const LOCAL_PAGE_MARKERS = ['Build Production-Ready', 'Enterprise IT Solutions for Philippine MSMEs'];
